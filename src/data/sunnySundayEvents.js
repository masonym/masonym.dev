...
export const sunnySundaySchedule = [
  {
    date: "2024-12-22",
    events: ["hexa_enhancement", "monster_park_exp"],
    source: "Patch Notes",
  },
  {
    date: "2024-12-29",
  ...
  {
    date: "2025-02-16",
    events: ["star_force_discount", "monster_park_exp"],
    source: "Patch Notes",
  },
  {
    date: "2025-02-23",
    events: ["rune_cooldown", "rune_exp", "combo_kill_exp"],
    source: "Patch Notes",
  },
  {
    date: "2025-03-02",
  ...
  {
    date: "2025-03-09",
    events: ["star_force_51015", "monster_collection", "monsterblooms"],
    source: "Patch Notes",
  },
  {
    date: "2025-03-16",
    events: ["hexa_enhancement"],
    source: "Patch Notes",
  },
  {
    date: "2025-03-23",
    events: ["star_force_discount"],
    source: "Patch Notes",
  },
  {
    date: "2025-03-30",
  ...
  {
    date: "2025-09-28",
    events: ["star_force_discount", "hexa_enhancement"],
    source: "Patch Notes",
  },
  {
    date: "2025-10-05",
  ...
  {
    date: "2025-11-30",
    events: ["star_force_discount", "star_force_protection"],
    source: "Patch Notes",
  },
  {
    date: "2025-12-07",
  ...
  {
    date: "2026-01-11",
    events: ["treasure_hunter_exp", "ability_reset_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-01-18",
    events: ["star_force_discount", "monster_collection"],
    source: "Patch Notes",
  },
  {
    date: "2026-01-25",
  ...
  {
    date: "2026-02-01",
    events: ["ability_reset_discount", "spell_trace_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-02-08",
    events: ["treasure_hunter_exp", "sol_erda_2x", "monster_park_exp"],
    source: "Patch Notes",
  },
  {
    date: "2026-02-15",
  ...
  {
    date: "2026-02-22",
    events: ["monster_park_exp", "rune_cooldown", "rune_exp", "combo_kill_exp"],
    source: "Patch Notes",
  },
  {
    date: "2026-03-01",
    events: ["star_force_protection", "star_force_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-03-08",
    events: ["treasure_hunter_exp", "sol_erda_2x", "ability_reset_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-03-15",
    events: ["hexa_enhancement", "spell_trace_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-03-22",
  ...
  {
    date: "2026-03-29",
    events: ["star_force_protection", "ability_reset_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-04-05",
  ...
  {
    date: "2026-04-19",
    events: ["sol_erda_2x", "rune_cooldown", "rune_exp"],
    source: "Patch Notes",
  },
  {
    date: "2026-04-26",
    events: ["ability_reset_discount", "combo_kill_exp", "monster_park_exp"],
    source: "Patch Notes",
  },
  {
    date: "2026-05-03",
  ...
  {
    date: "2026-05-10",
    events: ["hexa_enhancement", "combo_kill_exp"],
    source: "Patch Notes",
  },
  {
    date: "2026-05-17",
  ...
  {
    date: "2026-05-24",
    events: ["magnificent_souls", "combo_kill_exp"],
    source: "Patch Notes",
  },
  {
    date: "2026-05-31",
  ...
  {
    date: "2026-06-14",
    events: ["star_force_oneplusone", "ability_reset_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-06-21",
  ...
  {
    date: "2026-07-12",
    events: ["hexa_enhancement", "ability_reset_discount"],
    source: "Patch Notes",
  },
  {
    date: "2026-07-19",
  ...
  },
  {
    ...
    events: [
      ...
      {
        isCustom: true,
        name: "Spiegelette's Golden Strawberry Farm One-Time Entry Pass (x2)",
        shortName: "Golden Strawberry Farm Pass x2",
        icon: "/sunnySundayIcons/strawberry-pass.png",
        category: "item",
      },
    ],
    source: "Patch Notes",
  ...
  {
    date: "2026-08-09",
    events: ["combo_kill_exp", "elite_monster_spawn", "sol_erda_2x"],
    source: "Patch Notes",
  },
  {
    date: "2026-08-16",
  ...
  },
  {
    ...
    events: [
      {
        isCustom: true,
        name: "Haste Fever Time Booster (x3)",
        shortName: "Haste Fever Booster x3",
        icon: "/sunnySundayIcons/haste-booster.png",
        category: "item",
      },
      "elite_monster_spawn",
      "sol_erda_2x",
...
export const hasShiningStarForce = (events) => {
  ...
  const hasDiscount = resolvedEvents.some(
    (e) => e.id === "star_force_discount",
  );
  const hasProtection = resolvedEvents.some(
    (e) => e.id === "star_force_protection",
  );
