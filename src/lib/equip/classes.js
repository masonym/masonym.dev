...
export const CLASSES = [
  { key: 'all',      label: 'All classes', mask: null, mainStat: null,  subStat: null },
  { key: 'warrior',  label: 'Warrior',     mask: 1,    mainStat: 'str', subStat: 'dex' },
  { key: 'magician', label: 'Magician',    mask: 2,    mainStat: 'int', subStat: 'luk' },
