...
const ELEMENTS = {
  fire: {
    icon: `${ELEMENT_ICON_DIR}/fire.png`,
    styles: "bg-red-500/15 text-red-300",
  },
  ice: {
    icon: `${ELEMENT_ICON_DIR}/ice.png`,
    styles: "bg-cyan-500/15 text-cyan-300",
  },
  lightning: {
    icon: `${ELEMENT_ICON_DIR}/lightning.png`,
  ...
  poison: {
    icon: `${ELEMENT_ICON_DIR}/poison.png`,
    styles: "bg-green-500/15 text-green-300",
  },
  holy: {
    icon: `${ELEMENT_ICON_DIR}/holy.png`,
    styles: "bg-yellow-500/15 text-yellow-300",
  },
  dark: {
    icon: `${ELEMENT_ICON_DIR}/dark.png`,
    styles: "bg-purple-500/15 text-purple-300",
  },
  "non-elemental": {
    icon: `${ELEMENT_ICON_DIR}/none.png`,
    styles: "bg-gray-500/15 text-gray-300",
  },
};

const TYPES = {
  human: {
    icon: `${TYPE_ICON_DIR}/human.png`,
    styles: "bg-orange-500/15 text-orange-300",
  },
  beast: {
    icon: `${TYPE_ICON_DIR}/beast.png`,
    styles: "bg-emerald-500/15 text-emerald-300",
  },
  aquatic: {
    icon: `${TYPE_ICON_DIR}/aquatic.png`,
    styles: "bg-blue-500/15 text-blue-300",
  },
  mechanical: {
    icon: `${TYPE_ICON_DIR}/machine.png`,
    styles: "bg-slate-400/15 text-slate-300",
  },
  fairy: {
    icon: `${TYPE_ICON_DIR}/fairy.png`,
    styles: "bg-pink-500/15 text-pink-300",
  },
  devil: {
    icon: `${TYPE_ICON_DIR}/devil.png`,
    styles: "bg-rose-500/15 text-rose-300",
  },
  plant: {
    icon: `${TYPE_ICON_DIR}/plant.png`,
    styles: "bg-lime-500/15 text-lime-300",
  },
  reptile: {
    icon: `${TYPE_ICON_DIR}/reptile.png`,
    styles: "bg-teal-500/15 text-teal-300",
  },
  undead: {
    icon: `${TYPE_ICON_DIR}/undead.png`,
